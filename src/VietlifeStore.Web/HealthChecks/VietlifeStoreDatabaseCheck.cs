...
public class VietlifeStoreDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public VietlifeStoreDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
