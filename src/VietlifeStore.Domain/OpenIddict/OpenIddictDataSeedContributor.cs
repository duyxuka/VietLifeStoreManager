...
namespace VietlifeStore.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("VietlifeStore") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "VietlifeStore", DisplayName = "VietlifeStore API", Resources = { "VietlifeStore" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["VietlifeStore_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["VietlifeStore_App:RootUrl"]?.TrimEnd('/');
            await CreateApplicationAsync(
                ...
                secret: configurationSection["VietlifeStore_App:ClientSecret"] ?? "1q2w3e*",
        ...
        {
            var swaggerRootUrl = configurationSection["VietlifeStore_Swagger:RootUrl"]?.TrimEnd('/');
